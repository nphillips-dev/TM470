...
SELECT unique_beers.id as unique_id, versioned_beers.id as 'beer_id', unique_beers.name, countries.id as 'country_id', countries.country, versioned_beers.version  
FROM unique_beers
